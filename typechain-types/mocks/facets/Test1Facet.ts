...
export interface Test1FacetInterface extends utils.Interface {
  ...
  events: {
    "Test1Event(uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Test1Event"): EventFragment;
}

export interface Test1EventEventObject {
  funcNum: BigNumber;
}
export type Test1EventEvent = TypedEvent<[BigNumber], Test1EventEventObject>;

export type Test1EventEventFilter = TypedEventFilter<Test1EventEvent>;
...
export interface Test1Facet extends BaseContract {
  ...
  filters: {
    "Test1Event(uint256)"(funcNum?: null): Test1EventEventFilter;
    Test1Event(funcNum?: null): Test1EventEventFilter;
  };
