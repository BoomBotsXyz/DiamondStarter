...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "IERC165Updater",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.IERC165Updater__factory>;
    getContractFactory(
      name: "IERC173",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractFactory(
      name: "FallbackFacet",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.FallbackFacet__factory>;
    getContractFactory(
      name: "RevertFacet",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.RevertFacet__factory>;
    getContractFactory(
      name: "Test1Facet",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.IERC165Updater>;
    getContractAt(
      name: "IERC173",
      address: string,
      signer?: ethers.Signer
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.FallbackFacet>;
    getContractAt(
      name: "RevertFacet",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.RevertFacet>;
    getContractAt(
      name: "Test1Facet",
      address: string,
      signer?: ethers.Signer
